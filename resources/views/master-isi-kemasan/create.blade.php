...
@section('title', 'Tambah Isi Kemasan')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Tambah Isi Kemasan</h1>
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Form Tambah Isi Kemasan
        </div>
        <div class="card-body">
            <form action="{{ route('master-isi-kemasan.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('nama_isi_kemasan') }}"
                           placeholder="Contoh: Strip, Kotak, Botol, Vial, Tube"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           name="singkatan" 
                           value="{{ old('singkatan') }}"
                           placeholder="Contoh: Strp, Ktk, Btl"
                           maxlength="20">
