...
@section('title', 'Edit WhatsApp Validator')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">
                    <i class="bi bi-pencil"></i> Edit WhatsApp Validator
                </h4>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
            <form action="{{ route('master-whatsapp-validator.update', $validator->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           id="nama_validator" 
                           name="nama_validator" 
                           value="{{ old('nama_validator', $validator->nama_validator) }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" 
                               ...
                               id="nomor_wa" 
                               name="nomor_wa" 
                               value="{{ old('nomor_wa', $validator->nomor_wa) }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                              ...
                              name="keterangan" 
                              rows="3"
                              placeholder="Contoh: Validator utama untuk distribusi obat">{{ old('keterangan', $validator->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" 
                           ...
                           id="is_active" 
                           name="is_active" 
                           {{ old('is_active', $validator->is_active) ? 'checked' : '' }}>
