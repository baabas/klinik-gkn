            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <form action="{{ route('laporan.penyakit') }}" method="GET">
                            <div class="flex">
                            ...
                            <tbody>
                                @forelse ($daftar_penyakit as $penyakit)
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="p-2 border text-left">{{ $penyakit->nama_penyakit }}</td>
                                        <td class="p-2 border text-left">{{ $penyakit->kode_penyakit }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ $filter['jumlah_hari'] + 3 }}" class="p-4 text-center">Tidak ada data kasus penyakit pada bulan ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
